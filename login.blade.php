                        ...
                        @if ($errors->has('email') || $errors->has('g-recaptcha-response'))
                            <div class="form-group{{ $errors->has('g-recaptcha-response') ? ' has-error' : '' }}">
                                ...
                                <div class="text-xs-center">
                                   @if(config(["no-captcha.sitekey" => getOption('recaptcha_public_key')])==null && $errors->has('email') || $errors->has('g-recaptcha-response'))
...
@endif
                        ...
                        @endif
                        <button type="submit" class="btn btn-primary btn-lg btn-block">@lang('buttons.login')</button>
