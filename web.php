...
// Installer routes
Route::get('/start','InstallerController@index');    
Route::post('/authenticate','InstallerController@authenticate');  
Route::get('/versionchecker','InstallerController@versionchecker');    
Route::get('/dbconfiguration','InstallerController@configuration');    
Route::post('/dbconfiguration','InstallerController@updateenv');    
